...
#cd /home/jovyan/shares/SR003.nfs2/caduseus_artem/phage/ModernBERT
CKPT="base_metavr_kmer"
TASK="simple_test_${CKPT}_cosine_new_dataset"
CONFIG="${CONFIG_DIR}/simple_test_kmer_new_dataset.yaml"


MODERNBERT_HOME="/home/jovyan/shares/SR003.nfs2/caduseus_artem/phage/ModernBERT" CUDA_VISIBLE_DEVICES=5 python finetuning/train_with_accelerate.py \
    --config $CONFIG \
...
CONFIG="${CONFIG_DIR}/simple_test_kmer_dropout_0.1.yaml"
